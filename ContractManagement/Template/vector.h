...
public:
    ...
    VectorDinamic& operator=(VectorDinamic&& obiect) noexcept ;

    void push_back(const Element& element);

    Element& get(int pozitie) const noexcept;

    [[maybe_unused]] void set(int pozitie, const Element& element);
...
template<typename Element>
VectorDinamic<Element>& VectorDinamic<Element>::operator=(VectorDinamic&& obiect) noexcept
{
    if (this == &obiect) {
        return *this;
    }
...
template <typename Element>
[[maybe_unused]] void VectorDinamic<Element>::set(int pozitie, const Element& element)
{
...
template <typename Element>
[[maybe_unused]] bool IteratorVector<Element>::valid() const {
